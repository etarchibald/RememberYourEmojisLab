...
class EmojiTableViewController: UITableViewController {
    var emojis: [Emoji] = [
       ...
       Emoji(symbol: "🔪", name: "Knife", description: "A weapon of the Joker", usage: "Why so serious?"),
       Emoji(symbol: "🐍", name: "Snek", description: "danger noodle", usage: "snek eat bred"),
       Emoji(symbol: "👻", name: "Ghost", description: "when she doesn't text back", usage: "BOO"),
       Emoji(symbol: "🥚", name: "Egg", description: "Egg", usage: "Egg"),
       Emoji(symbol: "🍞", name: "Bread", description: "Stop being such a sour dough", usage: "Bread"),
